...
class RuntimeVersionDetector:
    ...
    def parse_version(self, version_string: Optional[str] = None) -> Dict[str, Any]:
        ...
        version_info = {
            ...
            "stage": stage,
            "variant": variant,
            "variant_name": self.RUNTIME_VARIANTS.get(variant, variant) if variant else None,
    ...
    def get_feature_availability(self, runtime_version: Optional[str] = None) -> Dict[str, bool]:
        """
        ...
        if not version_info["major"]:
            ...
            return {feature: False for feature in self.FEATURE_MATRIX}
    ...
    def get_expected_spark_version(self, runtime_version: Optional[str] = None) -> Optional[str]:
        """
    ...
    def get_runtime_recommendations(self) -> Dict[str, Any]:
        ...
        if not version_info["major"]:
            recommendations["recommendations"].append({
                "type": "error",
                "message": "No Databricks runtime detected"
            })

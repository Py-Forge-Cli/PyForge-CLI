...
from .converter_selector import ConverterType, ConverterRecommendation
...
class FallbackManager:
        ...
        for i, converter_type in enumerate(fallback_chain):
            ...
            try:
                ...
                if not self._is_converter_available(converter_type):
                    ...
                    self.logger.warning(f"Converter {converter_type.value} not available")
                    continue
        ...
        report = {
            ...
            "by_converter": {
                conv: {
                    ...
                    "avg_duration": sum(a.duration_seconds for a in attempts) / len(attempts)
                }
            ...
            "by_reason": {
                reason: {
                    "count": len(attempts),
                    "converters": list(set(a.converter_type.value for a in attempts)),
    ...
    def _execute_conversion(
        ...
        timeout = self.CONVERTER_TIMEOUT.get(converter_type, 300)

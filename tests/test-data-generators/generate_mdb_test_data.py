...
def generate_mdb_table_structures():
    ...
    complex_structure = {
        "tables": {
            "Customers": {
                "columns": ["CustomerID", "FirstName", "LastName", "Email", "Phone", "Address", "City", "State", "ZipCode", "Country", "DateJoined"],
                "rows": 1000,
                "primary_key": "CustomerID"
            },
            "Orders": {
                "columns": ["OrderID", "CustomerID", "OrderDate", "ShipDate", "Total", "Status", "PaymentMethod"],
                "rows": 5000,
                "primary_key": "OrderID",
                "foreign_keys": {"CustomerID": "Customers.CustomerID"}
            },
            "OrderDetails": {
                "columns": ["DetailID", "OrderID", "ProductID", "Quantity", "UnitPrice", "Discount"],
                "rows": 15000,
        ...
        "relationships": [
            ...
            {"from": "OrderDetails.OrderID", "to": "Orders.OrderID", "type": "many-to-one"},
            {"from": "OrderDetails.ProductID", "to": "Products.ProductID", "type": "many-to-one"},
            {"from": "Products.CategoryID", "to": "Categories.CategoryID", "type": "many-to-one"}
        ]
    }
    ...
    edge_cases = {
        ...
        "special_names": {
            "tables": {
                "Table With Spaces": {"columns": ["Column With Space", "Normal_Column"], "rows": 10},

...
class TestExtensionIntegration:
    ...
    def test_list_extensions_command(self, runner):
        ...
        with patch(
            "pyforge_cli.extensions.discovery.entry_points",
            return_value=mock_entry_points,
        ):
            # Mock the extension to be available
            with patch(
                "pyforge_cli.extensions.databricks.DatabricksExtension"
            ) as mock_ext_class:
    ...
    def test_extension_hooks_in_convert(self, runner, temp_dir):
        ...
        post_results = manager.execute_hook(
            "hook_post_conversion", input_file=test_file
        )
    ...
    def test_extension_error_handling(self):
        ...
        with patch.object(
            ...
            with patch.object(
                manager.discovery, "load_extension_class", return_value=FailingExtension
            ):
    ...
    def test_multiple_extensions(self):
        ...
        with patch.object(
            ...
            with patch.object(manager.discovery, "load_extension_class") as mock_load:
                ...
                with patch.object(manager.loader, "load_all_extensions"):

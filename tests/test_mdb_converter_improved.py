...
class TestMDBConverterImproved:
    ...
    def test_get_metadata_from_real_file(self, converter, test_data_dir):
        ...
        if mdb_file.exists():
            with patch('pyforge_cli.converters.mdb_converter.detect_database_file') as mock_detect:
                ...
                with patch('pyforge_cli.converters.mdb_converter.MDBTableDiscovery') as mock_discovery_class:
                    mock_discovery = MagicMock()
                    mock_discovery.connect.return_value = True
                    mock_discovery.list_tables.return_value = ['Customers', 'Orders', 'Products']
                    mock_discovery.get_table_info.side_effect = [
                        type('TableInfo', (), {'row_count': 100, 'columns': [
                            type('Column', (), {'name': 'ID'}),
                            type('Column', (), {'name': 'Name'})
                        ]})(),
                        type('TableInfo', (), {'row_count': 500, 'columns': [
                            type('Column', (), {'name': 'OrderID'}),
                            type('Column', (), {'name': 'CustomerID'})
                        ]})(),
                        type('TableInfo', (), {'row_count': 50, 'columns': [
                    ...
                    assert metadata['table_names'] == ['Customers', 'Orders', 'Products']
            ...
            if mdb_file.exists():
                with patch('pyforge_cli.converters.mdb_converter.detect_database_file') as mock_detect:
                    ...
                    with patch('pyforge_cli.converters.mdb_converter.MDBTableDiscovery') as mock_discovery_class:
                        mock_discovery = MagicMock()
                        mock_discovery.connect.return_value = True
                        mock_discovery.list_tables.return_value = list(structure['tables'].keys())
                        ...
                        def mock_get_table_info(table_name):
                            ...
                            return type('TableInfo', (), {
                                ...
                                'columns': [type('Column', (), {'name': col}) for col in columns]
                            })()
            ...
            with patch('pyforge_cli.converters.mdb_converter.detect_database_file') as mock_detect:
                ...
                with patch('pyforge_cli.converters.mdb_converter.MDBTableDiscovery') as mock_discovery_class:
                    ...
                    mock_discovery.get_table_info.side_effect = [
                        ...
                        type('TableInfo', (), {'row_count': 10, 'columns': [
    ...
    def test_get_metadata_encrypted_database(self, converter, temp_dir):
        ...
        with patch('pyforge_cli.converters.mdb_converter.detect_database_file') as mock_detect:
            ...
            with patch('pyforge_cli.converters.mdb_converter.MDBTableDiscovery') as mock_discovery_class:
                mock_discovery = MagicMock()
                mock_discovery.connect.return_value = False  # Connection fails for encrypted DB
                mock_discovery_class.return_value = mock_discovery
    ...
    def test_get_metadata_table_info_error(self, converter, temp_dir):
        ...
        with patch('pyforge_cli.converters.mdb_converter.detect_database_file') as mock_detect:
            ...
            with patch('pyforge_cli.converters.mdb_converter.MDBTableDiscovery') as mock_discovery_class:
                ...
                mock_discovery.get_table_info.side_effect = Exception("Table info error")
                mock_discovery_class.return_value = mock_discovery
                ...
                assert metadata['table_details']['ErrorTable']['error'] == 'Table info error'
    ...
    def test_get_metadata_corrupted_file(self, converter, temp_dir):
        ...
        with patch('pyforge_cli.converters.mdb_converter.detect_database_file') as mock_detect:
            ...
            assert metadata['file_format'] == 'Microsoft Access Database'
            assert 'database_type' not in metadata or metadata['database_type'] == 'UNKNOWN'
    ...
    def test_get_metadata_large_database(self, converter, temp_dir):
        ...
        with patch('pyforge_cli.converters.mdb_converter.detect_database_file') as mock_detect:
            ...
            with patch('pyforge_cli.converters.mdb_converter.MDBTableDiscovery') as mock_discovery_class:
                ...
                assert metadata['total_rows'] == sum(i * 100 for i in range(1, 21))  # 21000

...
class TestOutputPathGeneration:
    ...
    def test_output_path_same_directory(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            temp_path / "test_document.txt"

            # Mock the entire plugin loading and registry system
            with patch("pyforge_cli.main.plugin_loader") as mock_loader, patch(
                "pyforge_cli.main.registry"
            ) as mock_registry, patch(
                "pyforge_cli.main.get_extension_manager"
            ) as mock_get_ext_manager:
    ...
    def test_verbose_shows_auto_generated_path(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch("pyforge_cli.main.plugin_loader") as mock_loader, patch(
                ...
                result = self.runner.invoke(
                    cli, ["--verbose", "convert", str(input_file), "--format", "txt"]
                )
                ...
                assert (
                    "Auto-generated output file" in result.output
    ...
    def test_output_format_extension_applied(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            input_file.write_bytes(b"%PDF-1.4 test content")  # Create actual file
            temp_path / "document.txt"  # Default format is txt
    ...
    def test_complex_filename_handling(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            input_file.write_bytes(b"%PDF-1.4 test content")  # Create actual file
            temp_path / "my.document.with.dots.and spaces.txt"
